...
ActiveRecord::Schema.define(version: 2020_08_15_143838) do
  ...
  create_table "artrelations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "book_id", null: false
    t.bigint "artist_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["artist_id"], name: "index_artrelations_on_artist_id"
    t.index ["book_id"], name: "index_artrelations_on_book_id"
  end
  ...
  create_table "ctgrelations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "book_id", null: false
    t.bigint "category_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["book_id"], name: "index_ctgrelations_on_book_id"
    t.index ["category_id"], name: "index_ctgrelations_on_category_id"
  end

  create_table "tagrelations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "book_id", null: false
    t.bigint "tag_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["book_id"], name: "index_tagrelations_on_book_id"
    t.index ["tag_id"], name: "index_tagrelations_on_tag_id"
  end
  ...
  add_foreign_key "tagrelations", "tags"
end
